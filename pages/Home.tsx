...
const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-0">
      ...
      {/* Brand Ethos */}
      <section className="bg-ivory py-12 md:py-20 px-8 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
            <div className="lg:col-span-6 space-y-6 md:space-y-8">
              <div className="reveal-on-scroll sr-right">
                ...
                <h2 className="text-slate font-serif font-bold text-4xl md:text-6xl leading-[1]">A Sanctuary of <br className="hidden md:block"/><span className="italic font-light text-terracotta">Arrival.</span></h2>
              </div>
              <div className="space-y-4 md:space-y-6 reveal-on-scroll sr-up" style={{ transitionDelay: '300ms' }}>
                <p className="text-slate/80 text-xl md:text-2xl font-medium leading-relaxed italic font-serif">Inspired by the Yoruba word for "arrival," Tidé signifies a transformative moment—a destination where every journey culminates in an unforgettable experience.</p>
      ...
      {/* Final CTA */}
      <section className="bg-ivory py-16 md:py-24 text-center px-8 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-[3px] bg-terracotta"></div>
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="reveal-on-scroll sr-up">
            <h2 className="font-serif italic font-light mb-6 md:mb-10 text-4xl md:text-7xl text-slate leading-[0.9] tracking-tighter">Start your next <br className="md:hidden"/>chapter with us</h2>
          </div>
